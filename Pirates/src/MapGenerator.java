...
/**
 * This class is used to randomly generate a map with noise, will write the map
 * to a file.
 * 
 * @author Devansh
 *
...
public class MapGenerator {
	...
	public void GenerateMap(PApplet drawer) {
		...
		try {
			...
			double[][] noiseMap = Noise.generateMap(mapWidth, mapHeight, seed, noiseScale, octaves, persistance,
					lacunarity, v, drawer);
