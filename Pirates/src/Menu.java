...
public class Menu {
	...
	public void draw() {
		...
		if (normal) {
			...
			drawer.text(
					"Try to buy materials when they are cheap <11G and sell them when they are expensive >13G to make a profit.\n\nOnly upgrade your ship when you have enough money left over to continue trading materials.",
					100, 350, 1000, 400);
