 ...
 */
public class Noise {
	public static double[][] generateMap(int mapWidth, int mapHeight, int seed, double scale, int octaves,
			double persistance, double lacunarity, Vector<Double> offset, PApplet drawer) {
